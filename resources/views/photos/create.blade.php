        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <a href="{{ url('albums/' . $album_id) }}" class="button secondary">Go Back</a>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('photos.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="songFile" class="col-md-4 control-label">Učitajte pjesmu:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="songName" class="col-md-4 control-label">Ime pjesme:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="coverImage" class="col-md-4 control-label">Cover slika:</label>
                                    <div class="col-md-6">
